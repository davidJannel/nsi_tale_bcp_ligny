# CH6 : Gestion des processus

??? note "Programme officiel"
    ![image](img/BO.png){: .center}

![image](img/meme_deadlock.jpeg){: .center width=40%}
...
![image](img/term_montage.png){: .center}
...
![image](img/kill.jpg){: .center width=50%}
...
![image](img/schedule.png){: .center width=80%}
...
![image](img/ciseaux.png){: .center width=30%}

#### 3.5.2 Le carrefour maudit
![image](img/stop.png){: .center width=40%}

#### 3.5.3 Le chômage éternel
![image](img/job.png){: .center width=30%}


### 3.6 TP : Mise en évidence de la situation d'interblocage
Notebook sur la situation d'interblocage en utilisant Python : [CH6_TP_interblocage.ipynb](data/CH6_TP_interblocage.ipynb)
