...
!!! example "Exercice"
    === "Énoncé"
        ...
        **Aide pour Matplotlib :** le code ci-dessous
        ...
        ![image](img/carre.png){: .center}
        
## 4. Le tri-fusion
En anglais le *merge sort*.

![image](img/merge_yoda.jpg){: .center width=60%}
...
![image](img/gif_fusion.gif){: .center}
...
![image](img/comparaison.png){: .center}


Une jolie animation permettant de comparer les tris :

![image](img/comparaisons.gif){: .center}
