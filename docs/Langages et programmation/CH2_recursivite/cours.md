...
![image](img/infini.jpeg){: .center width=60%}
...
Évidemment, comme prévu, ce programme ne s'arrête pas. Nous sommes obligés de l'arrêter manuellement. Nous sommes (volontairement) tombés dans un piège qui sera systématiquement présent lors d'une programmation récursive : [le piège de la boucle infinie](img/meme2.gif){target=_blank}.  
...
![image](img/google.png){: .center width=50%}
...
[![image](img/bd.png){: .center width=70%}](img/bd.png){:target="_blank"}
...
![](img/pile_exec.webp){: .center width=30%}
...
![image](img/arbre.png){: .center width=100%}
...
![image](img/prod.jpg){: .center width=40%}
